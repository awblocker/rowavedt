...
int main(int argc, char * argv[]) {
	...
	while ( (c=getopt(argc, argv, "c:d:i:m:n:s:t:h")) != -1 ) {
		...
		case 'h':
			...
			printf("BASISFILE BASISROWS BASISCOLS ");
			printf("DATAFILE DATAROWS PRIORFILE\n\n");
			printf("Options:\n");
			printf("-c\tSet column number for values. Note: This is base 0.\n");
			printf("\tDefaults to 1.\n");
			printf("-d\tSet df for t distribution of residuals.\n");
			printf("\tDefaults to 5.\n");
			printf("-i\tOptional ID for results.");
			printf("Used as filename for output.\n");
			printf("\tDefaults to DATAFILE.\n");
			printf("-m\tNumeric code for missing values.\n");
			printf("\tDefaults to 99.999\n");
			printf("-n\tMinimum number of observations required; else exit\n");
			printf("\tDefaults to 10\n");
			printf("-s\tSet dimension of smooth (low-resolution) partial");
			printf(" basis.\n\tMust be power of 2\n\tDefaults to 8.\n");
			printf("-t\tSet column number for times. Note: This is base 0.\n");
